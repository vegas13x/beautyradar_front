 ...
 * Пример для создания:
 *
 * class SomeClass(private val preferences: SharedPreferences){
 * var userName: String by SharedPreferencesDelegate(preferences, USER_NAME, "")
 * companion object {
...
class SharedPreferencesDelegate<TValue>(
